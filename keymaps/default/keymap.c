...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_split_4x6_3(
        ...
        _______, KC_HOME, KC_UP,   KC_END,  KC_PGUP, _______,    KC_LPRN, KC_RPRN, KC_LCBR, KC_RCBR, KC_BSLS, KC_GRV,
        _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, KC_SCLN,    KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_PIPE, KC_TILD,
        _______, KC_VOLD, KC_MUTE, KC_VOLU, KC_APP,  _______,    _______, KC_MPRV, KC_MPLY, KC_MNXT, KC_RSFT, _______,
